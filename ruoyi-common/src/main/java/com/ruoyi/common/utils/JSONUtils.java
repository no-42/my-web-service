...
//        dateModule.addSerializer(Date.class, new DateSerializer(false, new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")));
     ...
     * @return 子 json
     */
    public static String getFieldAsString(String json, String key) {
    ...
    public static <T> T parse(String json, Class<T> type) {
        if (json == null || type == null || json.isEmpty()) return null;
        T result;
        try {
    ...
    public static JsonNode parseAsJsonNode(String json) {
