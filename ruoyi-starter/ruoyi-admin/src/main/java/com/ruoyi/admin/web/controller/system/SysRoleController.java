...
import com.ruoyi.admin.service.SysPermissionService;
...
import com.ruoyi.admin.service.TokenService;
...
public class SysRoleController extends BaseController {
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody SysRoleEntity role) {
    ...
    @PutMapping
    public AjaxResult edit(@Validated @RequestBody SysRoleEntity role) {
        ...
        if (roleService.updateRole(role) > 0) {
            // 更新缓存用户权限
            LoginUser<SysUserEntity> loginUser = getLoginUser();
    ...
    public AjaxResult dataScope(@RequestBody SysRoleEntity role) {
        roleService.checkRoleAllowed(role);
        roleService.checkRoleDataScope(role.getId());
    ...
    public TableDataInfo unallocatedList(SysUserEntity user) {
        startPage();
    ...
    public AjaxResult cancelAuthUser(@RequestBody SysUserRoleEntity userRole) {
