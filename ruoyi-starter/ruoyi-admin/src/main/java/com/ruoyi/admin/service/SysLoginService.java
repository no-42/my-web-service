...
public class SysLoginService {
    ...
    public void recordLoginInfo(String userId) {
        ...
        sysUserEntity.setLoginIp(IpUtils.getIpAddr(ServletUtils.getRequest()));
        sysUserEntity.setLoginDate(DateUtils.getNowDate());
        userService.updateUserProfile(sysUserEntity);
    }
}
