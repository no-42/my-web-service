  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-tooltip content="修改" placement="top" v-if="scope.row.name !== 'admin'">
            <el-button
                type="text"
                icon="Edit"
          ...
          <el-tooltip content="删除" placement="top" v-if="scope.row.name !== 'admin'">
            <el-button
                type="text"
                icon="Delete"
          ...
          <el-tooltip content="数据权限" placement="top" v-if="scope.row.name !== 'admin'">
            <el-button
                type="text"
                icon="CircleCheck"
          ...
          <el-tooltip content="分配用户" placement="top" v-if="scope.row.name !== 'admin'">
            <el-button
                type="text"
                icon="User"
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm('确认要"' + text + '""' + row.name + '"角色吗?').then(function () {
    return changeRoleStatus(row.id, row.enable);
  }).then(() => {
