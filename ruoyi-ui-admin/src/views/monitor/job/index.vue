  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="任务组名" prop="group">
        <el-select v-model="queryParams.group" placeholder="请选择任务组名" clearable>
          <el-option
      ...
      <el-form-item label="任务状态" prop="enable">
        <el-select v-model="queryParams.enable" placeholder="请选择任务状态" clearable>
...
<!--      <el-table-column label="任务编号" width="100" align="center" prop="id"/>-->
      ...
      <el-table-column label="任务组名" align="center" prop="group">
        <template #default="scope">
          <dict-tag :options="sys_job_group" :value="scope.row.group"/>
        </template>
      </el-table-column>
...
function handleJobLog(row) {
  const jobId = row.id;
  router.push({path: "/monitor/job-log/index", query: {id: jobId}});
}
